...
export class ProgramsPage {
  ...
  async addPatientProgramEnrollment() {
    ...
    await this.page.locator('#completionDateInput').press('Tab'), delay(1000);
    await this.page.locator('#completionDateInput').fill('20/08/2024'), delay(1000);
  ...
  async updatePatientProgramEnrollment() {
    ...
    await this.page.locator('#enrollmentDateInput').fill('16/09/2024'), delay(1000);
    await this.page.locator('#completionDateInput').press('Tab'), delay(1000);
    await this.page.locator('#completionDateInput').clear();
    await this.page.locator('#completionDateInput').fill('21/09/2024'), delay(1000);
    await this.page.locator('#completionDateInput').press('Tab'), delay(1000);
